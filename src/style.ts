import {
    ...
    BrightBlackForegroundColorAttr, BrightBlueBackgroundColorAttr,
    BrightBlueForegroundColorAttr, BrightCyanBackgroundColorAttr,
    BrightCyanForegroundColorAttr,
    BrightGreenBackgroundColorAttr,
    BrightGreenForegroundColorAttr, BrightMagentaBackgroundColorAttr,
    BrightMagentaForegroundColorAttr,
    BrightRedBackgroundColorAttr,
    BrightRedForegroundColorAttr, BrightWhiteBackgroundColorAttr,
    BrightWhiteForegroundColorAttr, BrightYellowBackgroundColorAttr,
    ...
    DefaultUnderlineColorAttr, ExtendedBackgroundColorAttr,
...
export class Style {
    ...
    underline(color?: MaybeColor, style?: UnderlineStyle) {
        if (color) return new Style([...this.attributes, Style.underlineColorString(color), UnderlineAttr]);
        return new Style([...this.attributes, style || UnderlineStyle.SingleUnderline]);
    }
