...
const CASES = [
  { name: "empty", raw: "", stripped: "", width: 0, },
  { name: "ascii", raw: "hello", stripped: "hello", width: 5, },
  { name: "emoji", raw: "👋", stripped: "👋", width: 2, },
  { name: "wideemoji", raw: "🫧", stripped: "🫧", width: 2, },
  { name: "combining", raw: "a\u0300", stripped: "à", width: 1, },
  {
    name: "control",
  ...
  // {name: "dcsarabic", raw: "\x1bP?123$pسلام\x1b\\اهلا", "اهلا", width: 4,
  {
    name: "newline",
    raw: "hello\nworld",
    stripped: "hello\nworld",
  ...
  { name: "flag", raw: "🇸🇦", stripped: "🇸🇦", width: 2, },
];
describe("width", () => {
  it.each(CASES)("measures $name $raw", (test) => {
