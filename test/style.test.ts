...
import {BoldAttr, ExtendedColorIntroducerAttr, ExtendedUnderlineColorAttr, UnderlineAttr, UnderlineStyle} from "../src";
describe("Style", () => {
    ...
    describe("underline", () => {
        test("basic colors", () => {
            ...
            expect(style.attributes[0]).toMatch(`${ExtendedUnderlineColorAttr};${ExtendedColorIntroducerAttr};${BasicColor.Red}`)
        ...
        test("indexed colors", () => {
            ...
            expect(style.attributes[0]).toMatch(`${ExtendedUnderlineColorAttr};${ExtendedColorIntroducerAttr};${IndexedColor.AlienArmpit}`)
            expect(style.attributes[1]).toBe(UnderlineAttr);
        ...
        test("vector colors", () => {
            ...
            expect(vec.render("Hello")).toMatch("\x1b[58;2;128;128;128;4mHello\x1b[m");
        });
        test("rgb() colors", () => {
